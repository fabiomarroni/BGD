...
option_list = list(
  make_option(c("-I", "--indir"), type="character", default="05_kraken2",
              help="Input directory containing kraken reports", metavar="character"),
  make_option(c("-O", "--outfile"), type="character", default="04_tables/genus_bracken.txt", 
              help="output file name [default= %default]", metavar="character"),
  make_option(c("-N", "--nspecies"), type="numeric", default=15, 
              help="output file name [default= %default]", metavar="character"),
  make_option(c("-R", "--removeme"), type="character", default="10_SANO", 
              help="Comma delimited list of samples to remove [default= %default]", metavar="character"),
  make_option(c("-G", "--outgraph"), type="character", default="03_plots/genus_bracken_barplot.pdf", 
              help="output file name [default= %default]", metavar="character")
)

...
option_list = list(
  ...
  make_option(c("-O", "--removme"), type="character", default="04_tables/bracken.txt", 
  ...
  make_option(c("-G", "--outgraph"), type="character", default="03_plots/species_bracken_barplot.pdf", 
              help="output file name [default= %default]", metavar="character")
)
